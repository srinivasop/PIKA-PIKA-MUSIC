...
async def pause(client: Client, message: Message):
    ...
    await message.reply_text("**𝕷𝖊𝖌𝖊𝖓𝖉𝖘:** ⏸ Paused.")
...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("**𝕷𝖊𝖌𝖊𝖓𝖉𝖘:** ▶️ Resumed.")
...
async def stop(client: Client, message: Message):
    ...
    await message.reply_text("**𝕷𝖊𝖌𝖊𝖓𝖉𝖘:** ⏹ Stopped.")
...
async def skip(client: Client, message: Message):
    ...
    await message.reply_text("**𝕷𝖊𝖌𝖊𝖓𝖉𝖘:** ⏩ Skipped the current song.")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("**𝕷𝖊𝖌𝖊𝖓𝖉𝖘:** ❇️ Admin cache refreshed!")
